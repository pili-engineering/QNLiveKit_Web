...
export class AdminApi {
	...
	static getServerAuthAdminToken(params: GetServerAuthAdminTokenParams) {
		return request.get<
			GetServerAuthAdminTokenResult,
			GetServerAuthAdminTokenResult
		>('/server/auth/admin/token', { params });
	}
	...
	static postAdminCensorStopliveLiveId(
		...
		return request.post<
			PostAdminCensorStopliveLiveIdResult,
			PostAdminCensorStopliveLiveIdResult
		>(`/admin/censor/stoplive/${params.live_id}`, params);
	}
	...
	static getAdminCensorConfig(params?: GetAdminCensorConfigParams) {
		return request.get<GetAdminCensorConfigResult, GetAdminCensorConfigResult>(
			'/admin/censor/config',
			{ params }
		);
	}
	...
	static postAdminCensorAudit(params: PostAdminCensorAuditParams) {
		return request.post<PostAdminCensorAuditResult, PostAdminCensorAuditResult>(
			'/admin/censor/audit',
			params
		);
	}
	...
	static getAdminCensorLive(params: GetAdminCensorLiveParams) {
		return request.get<GetAdminCensorLiveResult, GetAdminCensorLiveResult>(
			'/admin/censor/live',
			{ params }
		);
	}
	...
	static getAdminCensorRecord(params: GetAdminCensorRecordParams) {
		return request.get<GetAdminCensorRecordResult, GetAdminCensorRecordResult>(
			'/admin/censor/record',
			{ params }
		);
	}
	...
	static postManagerLogin(params: PostManagerLoginParams) {
		return request.post<PostManagerLoginResult, PostManagerLoginResult>(
			'/manager/login',
			params
		);
	}
