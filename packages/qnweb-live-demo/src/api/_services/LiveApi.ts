import {
	getAccessToken,
	getAuthorization,
	GetClientAppConfigParams,
	GetClientAppConfigResult,
	...
	liveRequest,
	PostClientGiftSendParams,
	PostClientGiftSendResult,
...
export class LiveApi {
	...
	static getLiveAuthToken(params: GetLiveAuthTokenParams) {
		return request.get<GetLiveAuthTokenResult, GetLiveAuthTokenResult>(
			`/v1/live/auth_token`,
			{
				headers: {
	...
	static search(params: GetLiveRoomParams) {
		return liveRequest.get<GetLiveRoomResult, GetLiveRoomResult>(
			`/client/live/room`,
			{
				headers: {
					Authorization: getAccessToken()
	...
	static getRoomInfo(params: GetLiveRoomInfoLiveIdParams) {
		return liveRequest.get<
			GetLiveRoomInfoLiveIdResult,
			GetLiveRoomInfoLiveIdResult
		>(`/client/live/room/info/${params.live_id}`, {
			headers: {
				Authorization: getAccessToken()
			}
		});
	...
	static getRoomList(params: GetLiveRoomListParams) {
		return liveRequest.get<GetLiveRoomListResult, GetLiveRoomListResult>(
			`/client/live/room/list`,
			{
				headers: {
					Authorization: getAccessToken()
				},
	...
	static join(params: PostLiveRoomUserLiveIdParams) {
		return liveRequest.post<
			PostLiveRoomUserLiveIdResult,
			PostLiveRoomUserLiveIdResult
		>(`/client/live/room/user/${params.live_id}`, null, {
			headers: {
				Authorization: getAccessToken()
			}
		});
	...
	static heartbeat(params: GetLiveRoomHeartbeatLiveIdParams) {
		return liveRequest.get<
			GetLiveRoomHeartbeatLiveIdResult,
			GetLiveRoomHeartbeatLiveIdResult
		>(`/client/live/room/heartbeat/${params.live_id}`, {
			headers: {
				Authorization: getAccessToken()
			}
		});
	...
	static getStats(params: GetClientStatsSingleLiveLiveIdParams) {
		return liveRequest.get<
			GetClientStatsSingleLiveLiveIdResult,
			GetClientStatsSingleLiveLiveIdResult
		>(`/client/stats/singleLive/${params.live_id}`, {
			headers: {
				Authorization: getAccessToken()
			}
		});
	...
	static getGiftList(params: GetClientGiftConfigTypeParams) {
		return liveRequest.get<
			GetClientGiftConfigTypeResult,
			GetClientGiftConfigTypeResult
		>(`/client/gift/config/${params.type}`, {
			headers: {
				Authorization: getAccessToken()
			}
		});
	...
	static getLiveProduct(params: PostClientItemDemonstrateLiveIdItemIdParams) {
		return liveRequest.get<
			PostClientItemDemonstrateLiveIdItemIdResult,
			PostClientItemDemonstrateLiveIdItemIdResult
		>(`/client/item/demonstrate/${params.liveId}`, {
			headers: {
				Authorization: getAccessToken()
			}
		});
	...
	static sendGift(params: PostClientGiftSendParams) {
		return liveRequest.post<PostClientGiftSendResult, PostClientGiftSendResult>(
			`/client/gift/send`,
			params,
			{
				headers: {
	 ...
	 */
	static getAppConfig() {
		return liveRequest.get<GetClientAppConfigResult, GetClientAppConfigResult>(
			`/client/app/config`,
			{
				headers: {
					Authorization: getAccessToken()
