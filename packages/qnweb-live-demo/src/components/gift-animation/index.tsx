 ...
 * 礼物动画
 */
export const GiftAnimation = React.forwardRef<
	GiftAnimationHandler,
	GiftAnimationProps
>(function GiftAnimation(props, ref) {
	const { className, style, max = 3 } = props;
						...
						>
							<div className={`${prefixCls}-item`}>
								<div className={`${prefixCls}-item-main`}>
									<Avatar
										className={`${prefixCls}-item-main-avatar`}
										src={item.avatar}
									/>
									<div className={`${prefixCls}-item-main-content`}>
										<div className={`${prefixCls}-item-main-content-title`}>
											{item.username}
										</div>
										<div className={`${prefixCls}-item-main-content-subtitle`}>
											{item.content}
										</div>
									</div>
								</div>
